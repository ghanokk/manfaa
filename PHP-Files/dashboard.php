...
<head>
    ...
    <style>
        ...
        .dashboard-header {
            background: linear-gradient(135deg, #2563eb 0%, #6fb1ff 100%);
            color: white;
            padding: 40px 20px;
            margin-bottom: 40px;
            border-radius: 10px;
            ...
            <div class="recent-courses">
                <?php foreach ($recentCourses as $course): ?>
                    <div class="course-item">
                        ...
                        <a href="cdetail.php?id=<?php echo $course['id']; ?>" class="course-item-action">View</a>
                    </div>
                <?php endforeach; ?>
        ...
        ?>
            ...
            <div style="background: linear-gradient(135deg, #f0f4ff 0%, #faf5ff 100%); border-radius: 12px; overflow: hidden; box-shadow: 0 2px 8px rgba(0,0,0,0.05);">
                <?php foreach ($registrations as $index => $reg): ?>
                    ...
                    ?>
                    <div style="padding: 20px; border-bottom: 1px solid #e5d7ff; background: #2076e7c4; transition: background 0.2s;">
                        <div style="display: flex; justify-content: space-between; align-items: flex-start; gap: 20px;">
                            <div style="flex: 1;">
                                ...
                                <div style="display: grid; grid-template-columns: repeat(auto-fit, minmax(220px, 1fr)); gap: 16px; margin-top: 12px;">
                                    <div>
                                        <p style="margin: 0 0 4px 0; color: #6b7280; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">Ticket Number</p>
                                    ...
                                    <div>
                                        <p style="margin: 0 0 4px 0; color: #6b7280; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">Event Date</p>
                                        <p style="margin: 0; font-weight: 600; color: #0b1220;"><?php echo $eventDateTime->format('M d, Y'); ?></p>
                                        <p style="margin: 2px 0 0 0; color: #6b7280; font-size: 0.85rem;"><?php echo $eventDateTime->format('g:i A'); ?></p>
                                    </div>
                                    <div>
                                        <p style="margin: 0 0 4px 0; color: #6b7280; font-size: 0.8rem; text-transform: uppercase; letter-spacing: 0.5px; font-weight: 600;">Registered</p>
                                        <p style="margin: 0; font-weight: 600; color: #0b1220;"><?php echo date('M d, Y', strtotime($reg['registered_at'])); ?></p>
                                        <p style="margin: 2px 0 0 0; color: #6b7280; font-size: 0.85rem;"><?php echo date('g:i A', strtotime($reg['registered_at'])); ?></p>
                                    </div>
                                </div>
                            </div>
